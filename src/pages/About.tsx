...
export default function About() {
  return (
    <div className="pt-20">
      ...
      {/* Intro Grid */}
      <section className="section-padding pt-0 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="relative group overflow-hidden rounded-[60px] aspect-[4/5]">
          <img 
        ...
        <div className="space-y-10">
          ...
          <p className="text-brand-ink/60 leading-loose text-lg">
      ...
      <section className="bg-brand-ink text-white py-32 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-20">
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-serif italic text-brand-gold">Friendly Staff</h3>
            <p className="text-white/50 leading-relaxed">Our professionals aren't just experts; they're your beauty partners. We listen before we style.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-serif italic text-brand-gold">Hygienic Standard</h3>
            <p className="text-white/50 leading-relaxed">Safety first. We maintain strict hygiene protocols and medical-grade sterilization for all tools.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-serif italic text-brand-gold">Premium Products</h3>
            <p className="text-white/50 leading-relaxed">We never compromise. Only the world's finest beauty products touch your hair and skin.</p>
          </div>
        </div>
      </section>
